...
|--------|-------|
| accuracy | 0.9485 |
| adversarial_precision | 0.9488 |
| adversarial_recall | 0.9994 |
| adversarial_f1 | 0.9735 |
| benign_precision | 0.8889 |
| benign_recall | 0.0851 |
| benign_f1 | 0.1553 |
...
|-----|-------|----------------|----------|
| 0.5-0.6 | 28 | 0.560 | 0.643 |
| 0.6-0.7 | 29 | 0.657 | 0.655 |
| 0.7-0.8 | 148 | 0.757 | 0.797 |
