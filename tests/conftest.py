...
def sample_dataframe():
    ...
    rows = [
        # Unicode attacks
        {
            "modified_sample": "héllö wörld",
            "original_sample": "hello world",
            "attack_name": "Diacritcs",
            "label_binary": "adversarial",
            "label_category": "unicode_attack",
            "label_type": "Diacritcs",
            "prompt_hash": "aaa111",
        },
        {
            "modified_sample": "he\u200bllo wo\u200brld",
            "original_sample": "hello world",
            "attack_name": "Zero Width",
            "label_binary": "adversarial",
            "label_category": "unicode_attack",
            "label_type": "Zero Width",
            "prompt_hash": "aaa111",
        },
        {
            "modified_sample": "hеllo wоrld",
            "original_sample": "hello world",
            "attack_name": "Homoglyphs",
            "label_binary": "adversarial",
            "label_category": "unicode_attack",
        ...
        # NLP attacks
        {
            "modified_sample": "greetings earth",
            "original_sample": "hello world",
            "attack_name": "BAE",
            "label_binary": "adversarial",
        ...
        {
            "modified_sample": "salutations globe",
            "original_sample": "hello world",
        ...
        {
            "modified_sample": "t̲e̲s̲t̲ input",
            "original_sample": "test input",
            "attack_name": "Diacritcs",
            "label_binary": "adversarial",
            "label_category": "unicode_attack",
            "label_type": "Diacritcs",
        ...
        {
            "modified_sample": "experiment entry",
            "original_sample": "test input",
            "attack_name": "BAE",
            "label_binary": "adversarial",
            "label_category": "nlp_attack",
        ...
        {
            "modified_sample": "good morning",
            "original_sample": "good morning",
            "attack_name": "benign",
            "label_binary": "benign",
            "label_category": "benign",
            "label_type": "benign",
        ...
        {
            "modified_sample": "how are you",
            "original_sample": "how are you",
            "attack_name": "benign",
            "label_binary": "benign",
            "label_category": "benign",
            "label_type": "benign",
