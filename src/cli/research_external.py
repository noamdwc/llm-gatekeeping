...
def _llm_result_to_row(result: dict, sample_id: str) -> dict:
    ...
    return {
        ...
        "clf_logprob_margin": result.get("clf_logprob_margin"),
        ...
        "judge_logprob_margin": result.get("judge_logprob_margin"),
        "logprob_margin": result.get("logprob_margin"),
    }
