...
DEBERTA_ARTIFACTS_DIR = ROOT / "artifacts" / "deberta_classifier"
DEBERTA_REPORTS_DIR = REPORTS_DIR / "deberta_classifier"
...
def ensure_dirs():
    ...
    for d in [
        ...
        REPORTS_BASELINES_DIR, DEBERTA_ARTIFACTS_DIR, DEBERTA_REPORTS_DIR,
    ]:
